...
/*jb.js v1.0*/
var render=function(d){var c=$(d.element);if(c.length<=0){throw"JB: The dom ("+d.element+") is not found";return}var b=c.html();var a=template.render(b,d.data);c.html("");c.html(a)};var JB={render:render};